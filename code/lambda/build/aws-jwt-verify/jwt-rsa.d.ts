import { JwksCache, Jwk, RsaSignatureJwk, Jwks } from "./jwk.js";
import { JwtHeader, JwtPayload, SupportedSignatureAlgorithm } from "./jwt-model.js";
 ...
 */
export declare type JwsVerificationFunctionSync = (props: {
 ...
 */
export declare type JwsVerificationFunctionAsync = AsAsync<JwsVerificationFunctionSync>;
/**
 ...
 */
export declare abstract class JwtRsaVerifierBase<SpecificVerifyProperties extends Record<string | number, unknown>, IssuerConfig extends JwtRsaVerifierProperties<SpecificVerifyProperties>, MultiIssuer extends boolean> {
    private jwksCache;
 ...
 */
declare type GenericKeyObject = Object;
/**
 ...
 */
export declare type JwkToKeyObjectTransformerSync = (jwk: RsaSignatureJwk, jwtHeaderAlg?: SupportedSignatureAlgorithm, issuer?: string) => GenericKeyObject;
/**
 ...
 */
export declare type JwkToKeyObjectTransformerAsync = AsAsync<JwkToKeyObjectTransformerSync>;
/**
...
export declare class KeyObjectCache {
     ...
     */
    transformJwkToKeyObjectSync(jwk: RsaSignatureJwk, jwtHeaderAlg?: SupportedSignatureAlgorithm, issuer?: string): GenericKeyObject;
    /**
     ...
     * @returns the RSA public key in native key object format
     */
    transformJwkToKeyObjectAsync(jwk: RsaSignatureJwk, jwtHeaderAlg?: SupportedSignatureAlgorithm, issuer?: string): Promise<GenericKeyObject>;
